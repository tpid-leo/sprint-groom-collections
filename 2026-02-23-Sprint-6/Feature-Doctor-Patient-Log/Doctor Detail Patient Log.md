# Doctor Detail Patient Log

## Overview
UI ini menampilkan seluruh daftar pasien dengan doctor terkait. Fitur yang terkait dengan api adalah fitur search, filter(outlet/status), export(Excel/Csv).
## Requirement Visual
* Patient Log
